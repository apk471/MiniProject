      ...
      <form
        ...
        <div className="flex flex-col lg:items-center lg:flex-row md:pr-5 grow">
          <input
            ...
            className="h-full p-2 md:p-4 bg-transparent  md:text-2xl text-black grow outline-none"
          />
          <div>
            <input
              type="datetime-local"
        ...
        <div className="md:text-4xl text-[#3792FC]">
          <button
            className="rounded-full text-3xl md:text-5xl flex items-center justify-center"
            type="submit">
            <span>+</span>
          </button>
        </div>
