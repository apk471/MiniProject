...
const TodoItem = ({ todo }) => {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row justify-between rounded-lg px-2 my-4 gap-1 bg-[#4285f4] p-2">
        ...
        <div className="inline-block">
          <div className="flex items-center my-2 cursor-pointer">
            <input
              ...
              disabled={editable}
            />
            <div className="bg-transparent border-2 rounded-full border-[#f5ba13] h-5 w-5 md:h-8 md:w-8 flex flex-shrink-0 justify-center items-center focus-within:border-[#f5ba13]">
              <svg
      ...
      <div className="flex lg:flex-row items-center gap-x-3 justify-between w-full lg:w-fit">
        ...
        <div className="flex justify-between gap-3 md:gap-5">
          <button
            ...
            <i className={`ri-pencil-line ${editable ? "hidden" : ""}`} />
            <i className={`ri-save-line ${editable ? "" : "hidden"}`}></i>
          </button>
          <button
